...
a2a_config.vars = {
    ...
    process: function() {
        for (var e, a, t = a2a_config.vars.vars, n = 0, o = t.length; n < o; n++) "string" == typeof t[n] ? (e = t[n], a = undefined) : (e = t[n][0], a = t[n][1]), void 0 !== a && "undefined" == typeof a2a_config[e] && (a2a_config[e] = a)
    }
...
var a2a = a2a || {
    ...
    button: function(e) {
        ...
        o.getAttribute("onclick") && -1 != (o.getAttribute("onclick") + "").indexOf("a2a_") || o.getAttribute("onmouseover") && -1 != (o.getAttribute("onmouseover") + "").indexOf("a2a_") || (a2a.add_event(o, "click", function(e) {
            ...
            a ? a2a.toggle_dropdown("none", i) : 2 !== c && (a2a.show_menu(o), a2a[i].last_focus = t, r.focus()), (a && "none" !== a2a.getStyle(n(l + "_show_more_less"), "display") || 2 === c) && (a2a.show_full(), a2a[i].last_focus = t, s.focus())
    ...
    kit: function(i, e) {
        var a, t, n, o, l, s = i.type,
            ...
            M = {},
            j = {},
            H = i.linkurl_implicit && a2a.canonical_url ? encodeURIComponent(a2a.canonical_url).replace(/'/g, "%27") : E,
            P = h["a2a-scroll-show"],
            R = 0 <= v.indexOf("a2a_vertical_style");
        z && !isNaN(z) && (a2a.svg.load(), B && "unset" != B && a2a.svg.works() && (F && "unset" != F && (M.backgroundColor = F), N && "unset" != N.trim() && (N = N.trim())), g.style.lineHeight = j.height = j.lineHeight = D, j.width = 2 * z + "px", j.fontSize = "16px", R && (j.height = j.lineHeight = z / 2 + "px", j.fontSize = "10px", j.width = z + "px"), P && a2a.scrollToggle(g, P), 32 != z && (M.backgroundSize = M.height = M.lineHeight = M.width = D, j.borderRadius = M.borderRadius = (.14 * z).toFixed() + "px", j.fontSize = (parseInt(j.height, 10) + (R ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function() {
            ...
            window.fbAsyncInit || (window.fbAsyncInit = function() {
                FB.init({
                    ...
                    a2a.GA.track("Facebook Like", "facebook_like", e, "pages", "AddToAny Share/Save Button"), f("Facebook Like", W)
                })
                ...
                twttr.ready(function(e) {
                    a2a.twitter_bind || (e.events.bind("click", function(l) {
                        if (l && "tweet" == l.region) {
                            ...
                            e && e.url && (a2a.GA.track("Twitter Tweet", "twitter_tweet", unescape(e.url), "pages", "AddToAny Share/Save Button"), f("Twitter Tweet", W))
                        }
            ...
            "beside" == ue["pin-config"] && "buttonPin" == ue["pin-do"] && (W.style.width = "76px"), n.href = "https://www.pinterest.com/pin/create/button/?url=" + ue.url + (ue.media ? "&media=" + ue.media : "") + (ue.description ? "&description=" + encodeURIComponent(ue.description).replace(/'/g, "%27") : ""), a2a.add_event(W, "click", function() {
                a2a.GA.track("Pinterest Pin", "pinterest_pin", A, "pages", "AddToAny Share/Save Button"), f("Pinterest Pin", W)
            ...
            a2a.kit.linkedin_share_event = function() {
                a2a.GA.track("LinkedIn Share", "linkedin_share", A, "pages", "AddToAny Share/Save Button"), f("LinkedIn Share", W)
            ...
            window.google_plus_cb_a2a = function(e) {
                e.state && "off" == e.state || (a2a.GA.track("Google +1", "google_plusone", e.href, "pages", "AddToAny Share/Save Button"), f("Google +1", W))
            ...
            if (X && !se) {
                if (K || (W.target = te, !y || !r[X] && u(X, !0) ? "feed" == X ? W.href = W.href || i.linkurl : (W.href = "/#" + X, a2a.add_event(W, "mousedown", m), a2a.add_event(W, "keydown", m), W.rel = "nofollow" + ae) : W.href = (t = X, l = n = void 0, o = p(a = W, {})["a2a-follow"], l = r[t], o && l && (n = l.url.replace("${id}", o)), n || a.href), W.a2a = {}, W.a2a.customserviceuri = re, W.a2a.stype = le, W.a2a.linkurl = i.linkurl, W.a2a.servicename = ee, W.a2a.safename = X, ie.src && (W.a2a.js_src = ie.src), ie.url && (W.a2a.url = ie.url), ie.pu && (W.a2a.popup = 1), ie.media && (W.a2a.media = 1), g.a2a_codes = g.a2a_codes || [], g.a2a_codes.push(X), y || a2a.add_event(W, "click", function(n, o, i, l, r) {
                        return function(e) {
                            ...
                            f(o, r, e), a2a.postShare(g), r.a2a.popup && !a2a.defaultPrevented(e) && "javascript:" != r.href.substr(0, 11) && (a2a.preventDefault(e), window.open(r.href, "_blank", "toolbar=0,personalbar=0,resizable,scrollbars,status,width=550,height=450,top=" + (450 < a ? Math.round(a / 2 - 225) : 40) + ",left=" + Math.round(screen.width / 2 - 275))), a2a.util_frame_post(s, t), a2a.GA.track(o, n, i, "pages", "AddToAny Share/Save Button")
                        }
                    }(X, ee, A, C, W))), Q.length) {
                    for (var pe, me, fe, _e = 0, ge = Q.length; _e < ge; _e++)
                        ...
                        for (var he in ($ = document.createElement("span")).className = I + ne + " a2a_img_text", oe && ($.style.backgroundColor = "#" + oe), "pending" !== (G = a2a.svg.get(ne, $, N)) && ($.innerHTML = G), M) $.style[he] = M[he];
                        W.insertBefore($, Q[0])
                    }
                } else {
                    for (var he in ($ = document.createElement("span")).className = I + ne, oe && ($.style.backgroundColor = "#" + oe), "pending" !== (G = a2a.svg.get(ne, $, N)) && ($.innerHTML = G), M) $.style[he] = M[he];
    ...
    overlays: function() {
        ...
        function i(e, a, t, n) {
            var o, i, l, r, s, c, d, u, p, m = function f(e) {
            ...
            if (a2a.matches(m, n) && "false" !== m.getAttribute("data-a2a-overlay")) {
                ...
                i = a2a.getPos(m), a.style.display = "", s = a.clientHeight || a.offsetHeight, c = a.clientWidth || a.offsetWidth, t[0] && ("bottom" === t[0] ? h = m.height - s : "center" === t[0] && (h = x((m.height - s) / 2))), t[1] && ("right" === t[1] ? g = m.width - c : "center" === t[1] && (g = x((m.width - c) / 2))), d = i.left + g, u = i.top + h, a.style.left = d + "px", a.style.top = u + "px", a.setAttribute("data-a2a-media", m.src), (a.a2a_mediaNode = m).alt ? a.setAttribute("data-a2a-title", m.alt) : a.setAttribute("data-a2a-title", b), !v || "#" !== v.substr(0, 1) && "http" !== v.substr(0, 4) ? a.setAttribute("data-a2a-url", w) : (p = "#" === v.substr(0, 1) ? w.split("#")[0] + m.longDesc : v, a.setAttribute("data-a2a-url", p))
    ...
    getByClass: function(e, a, t) {
        return document.getElementsByClassName && /\{\s*\[native code\]\s*\}/.test("" + document.getElementsByClassName) ? a2a.getByClass = function(e, a, t) {
            ...
            for (var u = 0, p = r.length; u < p; u += 1) {
                n = r[u], o = !1;
                for (var m = 0, f = l.length; m < f && (o = l[m].test(n.className)); m += 1);
                o && s.push(n)
            }
            return s
    ...
    linker: function(e) {
        var a, t = location.href,
            ...
            i = o.type,
            l = e.a2a.safename,
            r = o.linkurl_implicit && t != o.linkurl ? t : o.linkurl,
            s = encodeURIComponent(r).replace(/'/g, "%27"),
            c = o.linkname_implicit && n != o.linkname ? n : o.linkname,
            ...
            f = !o.track_links || "page" != i && "mail" != i ? "" : "&linktrack=" + o.track_links + "&linktrackkey=" + encodeURIComponent(o.track_links_key),
            _ = e.a2a.customserviceuri || !1,
            g = e.a2a.stype,
            h = e.a2a.js_src,
            v = e.a2a.url,
            y = e.a2a.media,
        ...
        else if (v && (l != b || l == b && a2a.is_mobile) && !f) {
        ...
        } else _ && "undefined" != _ && (a = _.replace(/A2A_LINKNAME_ENC/, d).replace(/A2A_LINKURL_ENC/, s).replace(/A2A_LINKNOTE_ENC/, m));
        return e.href = a || "http" + a2a.c.http_s + "://www.addtoany.com/add_to/" + l + "?linkurl=" + s + "&linkname=" + d + (p ? "&linkmedia=" + p : "") + f + function E() {
            var e = "";
        ...
        }() + ("feed" == i ? "&type=feed" : "") + "&linknote=" + m, !0
    },
    animate: function(e, a, t) {
        var n = "none" !== a2a.getStyle(a, "display"),
            o = a.classList,
            i = "a2a_starting",
            l = "transitionend";
        if ("show" === e) {
    ...
    overlay: {
        ...
        hide: function(e) {
            var a = a2a.gEl("a2a" + a2a.type + "_overlay"),
                t = a2a.overlay,
                n = t.key_listener;
    ...
    hide_modals: function(e) {
        ...
        a2a.show_full.full_shown = !1, a2a.animate("hide", i), a2a.animate("hide", n), a2a.overlay.hide(function l() {
            o.style.display = n.style.display = i.style.display = "none", "none" !== a2a.getStyle(a(t + "_dropdown"), "display") && a(t + "_show_more_less").focus()
        })
    },
    show_modal: function() {
        for (var e = "a2apage", a = a2a.gEl, t = (a(e + "_overlay"), a(e + "_modal")), n = a2a.getByClass("a2a_modal_body", t), o = 0; o < n.length; o++) n[o].style.display = "none";
        a2a.overlay.show(), a2a.animate("show", t)
    },
    show_full: function() {
        var e = "a2a" + a2a.type,
            a = a2a.gEl,
    ...
    show_menu: function(e, a) {
        ...
        a2a.gEl(f + "_title").value = p.linkname, a2a.toggle_dropdown("block", m), t = [_.clientWidth, _.clientHeight], n = a2a.getDocDims("w"), o = a2a.getDocDims("h"), i = a2a.getScrollDocDims("w"), l = a2a.getScrollDocDims("h"), e ? ((r = e.getElementsByTagName("img")[0]) ? (s = a2a.getPos(r), c = r.clientWidth, d = r.clientHeight) : (s = a2a.getPos(e), c = e.offsetWidth, d = e.offsetHeight), s.left - i + t[0] + c > n && (s.left = s.left - t[0] + c - 8), ("up" == p.orientation || "down" != p.orientation && s.top - l + t[1] + d > o && s.top > t[1]) && (s.top = s.top - t[1] - d), _.style.left = (s.left < 0 ? 0 : s.left) + 2 + "px", _.style.top = s.top + d + "px") : (a || (a = {}), _.style.position = a.position || "absolute", _.style.left = a.left || n / 2 - t[0] / 2 + "px", _.style.top = a.top || o / 2 - t[1] / 2 + "px"), a2a[m].doc_click_close_mini || a2a[m].no_hide || (a2a[m].doc_click_close_mini = (u = m, function(e) {
    ...
    copyLink: function(e) {
        var a = "page",
            ...
            n = a2a.gEl,
            o = a2a.getStyle,
            i = (n(t + "_overlay"), n(t + "_full")),
            l = n(t + "_modal"),
            r = n("a2a_copy_link"),
            s = n("a2a_copy_link_copied"),
            c = n("a2a_copy_link_text");

        function d() {
            l.setAttribute("aria-label", "Copy link"), c.value = e, a2a.show_modal(), r.style.display = "block", r.focus(), a2a.stats("copy")
        }
        a2a.show_full.full_shown = "none" !== o(i, "display"), a2a.copyLink.clickListen || (a2a.add_event(c, "click", function(e) {
            c.setSelectionRange ? c.setSelectionRange(0, c.value.length) : c.select(), document.execCommand && document.execCommand("copy") && (c.blur(), s.style.display = "block", setTimeout(function() {
                l.style.display = r.style.display = s.style.display = "none", a2a.show_full.full_shown ? a2a.show_full() : a2a.hide_modals(a)
            }, 700))
        }), a2a.copyLink.clickListen = 1), a2a.type = a, a2a.show_full.full_shown ? a2a.animate("hide", i, d) : d()
    },
    thank: function() {
        var e = a2a.ads,
            a = "a2apage",
        ...
        function r() {
            n.setAttribute("aria-label", "Thanks for sharing"), a2a.show_modal(), i.style.display = "inline-block"
        }
        a2a.ads.lit() && l && (e.has() || l.postShare) && "none" === n.style.display && ("none" !== a2a.getStyle(o, "display") ? a2a.animate("hide", o, r) : r())
    },
    postShare: function(a) {
        var t = window,
            u = document,
            e = a2a.thank,
            n = "blur",
        ...
        function l() {
            a2a.stats("post"), a2a.thank(), t.removeEventListener(o, l), e[i] = 0
        }
        e[i] || (e[i] = 1, t.addEventListener(n, function r() {
            t.removeEventListener(n, r), t.addEventListener(o, l),
                function e(e) {
                    var a, t = a2a.gEl,
                        n = t("a2a_thanks"),
                        o = "a2a_thanks_kit",
                        i = t(o),
                        l = "",
                        r = e ? e.a2a_index : null,
                        s = e ? e.a2a_codes : ["facebook", "twitter", "email"],
                        c = a2a["n" + (r || a2a.n)];
                    i || ((i = u.createElement("div")).id = o, n.appendChild(i)), i.innerHTML = "", (a = u.createElement("div")).className = "a2a_kit a2a_kit_size_32 a2a_default_style", a.setAttribute("data-a2a-url", c.linkurl), a.setAttribute("data-a2a-title", c.linkname), c.linkmedia && a.setAttribute("data-a2a-media", c.linkmedia), a.style.display = "flex", a.style.justifyContent = "center";
                    for (var d = 0; d < s.length && d < 8; d++) l += '<a class="a2a_button_' + s[d] + '"></a>';
                    a.innerHTML = l, i.appendChild(a), a2a.init("page")
                }(a), a2a.ads.set()
        }))
    },
    ...
    domEval: function(e, a) {
        ...
        a.innerHTML = e,
            function t(e) {
                var a, t = e.querySelectorAll("script"),
                    n = [];
                [].forEach.call(t, function(t) {
                    (a = t.getAttribute("type")) && !i.test(a) || n.push(function(e) {
                        ! function a(e, a) {
    ...
    ads: {
        lit: function() {
            ...
            return /.blogspot.com$/.test(location.hostname) || document.querySelector && document.querySelector('meta[content="blogger"][name="generator"]') || e && e.postShare
        },
        has: function() {
            var e = {},
                a = !1,
                t = window;
            return ("object" == typeof adsbygoogle && adsbygoogle.loaded || "object" == typeof google_ad_modifications) && (e.as = a = !0), "object" == typeof googletag && (e.dc = a = !0), t.__SKIM_JS_GLOBAL__ && (e.sl = a = !0), (t.amazon_ad_tag || t.amzn_assoc_ad) && (e.az = a = !0), !!a && e
        },
        set: function() {
            var e = a2a.gEl,
                n = "div-gpt-ad-1538103557901-0",
                a = "a2a_thanks_ad",
                o = e(n),
                i = e(a),
                l = e("a2a_thanks"),
                t = a2a_config.thanks,
                r = "boolean" == typeof t && !1 === t || t && "boolean" == typeof t.ad && !1 === t.ad,
                s = t && "undefined" != typeof t.ad && !1 !== t.ad;
            (a2a.ads.lit() && a2a.ads.has() && !r || s) && (t && "string" == typeof t.ad && t.ad && .5 <= Math.random() ? function c() {
                if (o && (o.style.display = "none"), !i) {
                    var e = document.createElement("div");
                    e.id = a, l.appendChild(e), a2a.domEval(t.ad, e)
                }
            }() : function d() {
                if (!window.googletag || !googletag.apiReady) {
                    var e = document.createElement("script");
                    e.async = !0, e.src = "https://www.googletagservices.com/tag/js/gpt.js";
                    var a = document.getElementsByTagName("script")[0];
                    a.parentNode.insertBefore(e, a)
                }
                if (i && (i.style.display = "none"), o) googletag.cmd.push(function() {
                    googletag.pubads().refresh([a2a.ads.slot1])
                });
                else {
                    window.googletag = window.googletag || {}, googletag.cmd = googletag.cmd || [], googletag.cmd.push(function() {
                        a2a.ads.slot1 = googletag.defineSlot("/21718366105/post-share", [300, 250], n).setCollapseEmptyDiv(!0).addService(googletag.pubads()), googletag.pubadsReady || (googletag.pubads().setTagForChildDirectedTreatment(1), googletag.pubads().enableAsyncRendering(), googletag.enableServices())
                    });
                    var t = document.createElement("div");
                    (o = t).id = n, t.style = "width:auto;height:auto;max-height:250px;margin:45px auto 0;border-radius:6px;overflow:hidden", l.appendChild(t), googletag.cmd.push(function() {
                        googletag.pubads().addEventListener("slotRenderEnded", function(e) {
                            e.isEmpty || (o.style.height = "250px", o.style.width = "300px")
                        }), googletag.display(n)
                    })
                }
            }())
    ...
    stats: function(e) {
        if (a2a.stats.a2a = a2a.stats.a2a || {}, !a2a.stats.a2a[e]) {
            ...
            a = r && r.as ? "&as=1" : "", t = r && r.dc ? "&dc=1" : "", n = r && r.sl ? "&sl=1" : "", o = r && r.az ? "&az=1" : "", i = r ? "&ad=1" : "", (l = new XMLHttpRequest).open("POST", "https://stats.addtoany.com/menu"), l.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), l.timeout = 3e3, l.ontimeout = function(e) {
                l.abort()
    ...
    top_services: function(e, a, t) {
        ...
        if (e) {
            ...
            if (0 < u.length) {
                var f, _, g;
                for (p = 0, t = t; p < u.length; p++) g = (f = o(u[p].a2a.safename, d, !0, "a2a", "safename")) ? f : i((_ = u[p].a2a).servicename, _.safename, _.serviceIcon, _.serviceColor, {
                    src: _.js_src,
                    url: _.url,
                    type: _.serviceType,
                    pu: _.popup,
    ...
    localize: function() {
        ...
        for (var n, i, l, r, s = 0, c = e.length; s < c; s++)(i = (i = (n = e[s]).getAttribute("data-a2a-localize")) ? i.split(",", 2) : i) && (r = i[0], l = i[1], "inner" === r ? n.innerHTML = a[l] : "label" === r ? n.setAttribute("aria-label", t(a[l])) : "title" === r && n.setAttribute("title", t(a[l])))
    }
};
        ...
        if (a2a.type = a2a.c.menu_type || e, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
            a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_dropdown"] = function(e, a) {
                var t, n, r, o = a2a.gEl,
                    ...
                    f = (document.createElement("a"), s.icon_color),
                    _ = f ? f.split(",", 2) : f,
                    g = _ ? _[0] : _,
                    h = _ ? _[1] : _,
                ...
                if ("mail" != i) {
                    for (var S = 0, B = a.most, T = B.length, F = parseInt(a2a[i].num_services), N = 0, L = a2a[i].exclude_services; S < T; S++) {
                        var z = B[S];
                        L && a2a.in_array(z[1], L, !0) || p.appendChild(C(z[0], z[1], z[2], z[3], z[4])), !(N < F) || L && a2a.in_array(z[1], L, !0) || (m.appendChild(C(z[0], z[1], z[2], z[3], z[4])), N++)
                    }
                    o(l + "_full_services").appendChild(p), o(l + "_mini_services").appendChild(m)
                }
                t = o(l + "_full_services"), u.className = "a2a_i", n = u.cloneNode(), t.appendChild(u), t.appendChild(n);
                S = 0;
                for (var D = a.email, I = D.length; S < I; S++) {
                    z = D[S];
                    L && a2a.in_array(z[1], L, !0) || o(l + "_2_col1").appendChild(C(z[0], z[1], z[2], z[3], z[4]))
                }
                a2a[i].services = a.most.concat(a.email), "mail" != i && (a2a.add_event(o(l + "_overlay"), "click", function(e) {
                    a2a.hide_modals(i)
                }), a2a.add_event(o(l + "_show_more_less"), "click", function(e) {
                    a2a.preventDefault(e), a2a.show_more_less()
                })), a2a.arrange_services(), a2a.util_frame_listen(i), a2a.collections(i), a2a.default_services(), "mail" != i && ((r = o(l + "_find")).onkeydown = function(e) {
                    var a = (e = e || window.event).which || e.keyCode,
                        t = a2a.type;
                    if (13 == a) {
            ...
            }), a2a["create_" + n + "_dropdown"](n, a[i]), a2a.GA()
        }
    },
    function() {
        function e() {
