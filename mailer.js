              ...
              <tr>
                <td style="padding:0 0 20px 0;border-bottom:1px solid #e9edee;">
                  <a href="http://www.trusken.com" style="display:block; margin:0 auto;" target="_blank">
                    <img src="http://beta.trusken.com/images/truskenlogo.png" width="190" height="55" style="border: 0px;">
                  </a>
                </td>
              </tr>
              <tr>
...
function getFpassMailTemplate(eid){
  var q=""
  var mailTemplate=`<head>
  <script src="http://beta.trusken.com/js/jquery-2.1.4.min.js"></script>
  </head>
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" style="padding:30px 0;">
                ...
                <p>
                  <a style="display:inline-block;text-decoration:none;padding:15px 20px;background-color:#2baaed;border:1px solid #2baaed;border-radius:3px;color:#FFF;font-weight:bold;" href="http://beta.trusken.com/resetPassword.html?`+eid+`" target="_blank">Click to Reset Password</a>
                </p>
              </td>
            </tr>
            <tr>
...
module.exports = {sendMail,getMailTemplate,getFpassMailTemplate}
// module.exports = {sendMail,getFpassMailTemplate}
