            ...
            <tbody>
              ...
              <tr>
                <td colspan="2" style="padding:30px 0;">
                  ...
                  <p>
                    <a style="display:inline-block;text-decoration:none;padding:15px 20px;background-color:#2baaed;border:1px solid #2baaed;border-radius:3px;color:#FFF;font-weight:bold;" href="http://localhost:3000/verification?uid=`+uid+`" target="_blank">Yes, it's me – let's get started</a>
                  </p>
                </td>
              </tr>
              <tr>
