              ...
              <tr>
                <td style="padding:0 0 20px 0;border-bottom:1px solid #e9edee;">
                  <a href="http://www.trusken.com" style="display:block; margin:0 auto;" target="_blank">
                    <img src="http://test.trusken.com/images/ts1.png" width="200" height="75" style="border: 0px;">
                  </a>
                </td>
              </tr>
              <tr>
                <td colspan="2" style="padding:30px 0;">
                  ...
                  <p>
                    <a style="display:inline-block;text-decoration:none;padding:15px 20px;background-color:#2baaed;border:1px solid #2baaed;border-radius:3px;color:#FFF;font-weight:bold;" href="http://test.trusken.com/verification?uid=`+uid+`" target="_blank">Yes, it's me – let's get started</a>
                  </p>
                </td>
              </tr>
              <tr>
